...
# rt_dir = "/outputs/experiments/testing/2023-11-08_21-05"  #2023-04-20_01-33 2023-03-29_23-26
...
data_path = "/data/processed/2048/net_outputs/pcc_out/fine_cmplx"
save_path = "/data/processed/2048/net_outputs/p2m_rec_obj"
rlist = glob(os.path.join(save_path, f'config-r2/rec_*.obj'))
