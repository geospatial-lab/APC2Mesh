...
from base_utils.file_utils import save_args
...
llr_logger.info('ms:[10,20,30] | 256-trsf | 4heads | scale: x4 | bs: 8 | #ep: 140 |lr: 0.0006 | eta_min: 1e-07 | #tr/ts: 2k/40 | tr_loss: %s' %(args.tr_loss))
