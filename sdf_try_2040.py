...
def main():
    dataset_dir = "/data"
    num_processes = 8
    # fix_sample_cnt = '1024' # 2048, 3072, 4096
    '''to generate various, fixed sample count, line 511 through 556 are not needed because the inputs needed for the 
       fix_sampling function were already generated by sdf_try.py and saved to folder.'''
    ...
    for fix_sample_cnt in [1024, 3072, 4096]:
        fix_sampling(als_dir='processed/2048/clean_als_txt',
                    nmesh_dir='processed/2048/03_nnt_obj', 
